...
@frappe.whitelist(allow_guest=True)
def sign_up(email: str, full_name: str, grade: str, phone_number: str, service: str, institution: str, redirect_to: str) -> tuple[int, str]:
    """Fonction d'inscription étendue avec des champs personnalisés"""
    
    frappe.msgprint(_("hiiiiii"))  # Message pour vérifier que la fonction est appelée
